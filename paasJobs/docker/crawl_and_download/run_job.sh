...
function run_crawler() {
  ...
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/far_subpart_regs_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"
  ...
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/jcs_pubs_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"


    echo -e "\n RUNNING SCRAPY SPIDER: army_reserve_spider.py \n"
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/army_reserve_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"


    echo -e "\n RUNNING SCRAPY SPIDER: fasab_spider.py \n"
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/fasab_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"


    echo -e "\n RUNNING SCRAPY SPIDER: dfar_subpart_regs_spider.py \n"
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/dfar_subpart_regs_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"
  ...
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/cfr_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"


    echo -e "\n RUNNING SCRAPY SPIDER: us_code_spider.py \n"
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/us_code_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"


    echo -e "\n RUNNING SCRAPY SPIDER: legislation_spider.py \n"
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/legislation_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"
  ...
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/jumbo_dfar_far_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"


    echo -e "\n RUNNING SCRAPY SPIDER: fmr_spider.py \n"
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/fmr_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"


    echo -e "\n RUNNING SCRAPY SPIDER: opm_pubs_spider.py \n"
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/opm_pubs_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"


    echo -e "\n RUNNING SCRAPY SPIDER: nato_spider.py \n"
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/nato_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"
  ...
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/secnav_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"
  ...
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/ic_policies_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"


    echo -e "\n RUNNING SCRAPY SPIDER: executive_orders_spider.py \n"
  ( scrapy runspider dataPipelines/gc_scrapy/gc_scrapy/spiders/executive_orders_spider.py -o $LOCAL_CRAWLER_OUTPUT_FILE_PATH ) \
   || echo "^^^ CRAWLER ERROR ^^^"

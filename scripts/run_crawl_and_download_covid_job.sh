...
readonly SETTINGS_CONF_PATH="$SCRIPT_PARENT_DIR/../config/crawl-and-download-settings.conf"
readonly SANITY_CHECKS_CONF_PATH="$SCRIPT_PARENT_DIR/../config/sanity_checks.conf"

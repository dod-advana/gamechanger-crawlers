...
from dataPipelines.gc_scrapy.gc_scrapy.runspider_settings import (
    general_settings,
    selenium_settings,
)
from dataPipelines.gc_scrapy.gc_scrapy.middleware_utils.selenium_request import (
    SeleniumRequest,
)
...
class GCSeleniumSpider(GCSpider):
    ...
    @staticmethod
    def wait_until_css_clickable(
        driver, css_selector: str, wait: typing.Union[int, float] = 5
    ):
    ...
    @staticmethod
    def wait_until_css_not_located(
        driver, css_selector: str, wait: typing.Union[int, float] = 5
    ):

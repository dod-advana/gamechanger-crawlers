...
class DODCoronavirusSpider(GCSpider):
    ...
    def parse(self, response):
        ...
        for block in blocks:
            ...
            for item in items:
                ...
                (file_type, has_ext) = self.get_href_file_extension_does_exist(href_raw)
                ...
                if noted:
                    ...
                    supplamental_hrefs = item.css("*.noted a::attr(href)").getall()
                    supp_downloadable_items = [
                ...
                # some are links to other websites
                    ...
                    yield response.follow(
                        ...
                        meta={
                            "item": item,
                            "supp_downloadable_items": supp_downloadable_items,
                        },
                    )
    ...
    def parse_follow_page(self, response) -> typing.Union[DocItem, None]:
        ...
        href_finder = (
            self.get_body_hrefs
            if len(response.css("div.body"))
            else self.get_unknown_layout_hrefs
        )

...
class DCMASpider(GCSpider):
    ...
    start_urls = ["https://www.dcma.mil/Policy/"]
    ...
    def parse(self, response):
        ...
        for section in sections:
            ...
            for row in rows[1:]:
                ...
                policy_no_raw = row.css("td:nth-child(3)::text").get(default="")
                published_raw = row.css("td:nth-child(4)::text").get(default="")
                href_raw = row.css("td:nth-child(5) a::attr(href)").get(default="")

    ...
    def parse(self, response):
        ...
        for brickset in response.css(SET_SELECTOR):
            ...
            if response.url.endswith(('v1.html','v2.html','v3.html','v4.html')):
                ...
                announce_title=[]
                announce_num=[]
                [announce_num.append(x) for x in announce_num2 if len(re.sub(r'[^a-zA-Z0-9 ()\\-]', '', x))>5]
                [announce_title.append(x) for x in announce_title2 if len(re.sub(r'[^a-zA-Z0-9 ()\\-]', '', x))>5]
                url2=[]
                ...
                announce_num=[]
                url2=[]
                [announce_num.append(' '.join(x.split())) for x in announce_num2 if len(' '.join(x.split()))>5]
                [announce_title.append(' '.join(x.split())) for x in announce_title2 if len(' '.join(x.split()))>5]
